    ...
    >
        <div className='container-eco'>
            <div className='eco-botellas'>
                <h2>ECO <span className='verde-titulo'>BOTELLAS</span></h2>
        ...
        <section className='container-beneficios'>
                <h2>BENEFICIOS <span className='verde-titulo'>ECO-BOTELLAS</span></h2>
            <div className='beneficios'>
                <div className='beneficio'>
                    <h3 className='titulo-benef verde-titulo'>Personalizacion</h3>
                    <p>Ecobotellas diseñadas y fabricadas según tus necesidades.</p>
                </div>
                <div className='beneficio'>
                <h3 className='titulo-benef verde-titulo'>Calidad superior</h3>
                    <p>Materiales duraderos y resistentes que cumplen estándares exigentes.</p>
                </div>
                <div className='beneficio'>
                <h3 className='titulo-benef verde-titulo'>Sostenibilidad</h3>
                    <p>Materiales naturales o reciclados para evitar el consumo de plástico.</p>
                </div>
                <div className='beneficio'>
                <h3 className='titulo-benef verde-titulo'>Entrega puntual</h3>
